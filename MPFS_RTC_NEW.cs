...
{
    public class MPFS_RTC_NEW : BasicDoubleWordPeripheral, IKnownSize
    {
        public MPFS_RTC_NEW(IMachine machine) : base(machine)
        {
            DefineRegisters();
            WakeupIRQ = new GPIO();
            MatchIRQ = new GPIO();
        ...
        private DateTime timeToUpload = new DateTime(2000, 1, 1);
